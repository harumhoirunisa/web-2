...
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('pegawai.create')),'variant' => 'primary']); ?>New Pegawai <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        <tbody>
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $pegawais; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pegawai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="bg-gray-800 text-white">
                    <td class="py-2 px-4 border border-gray-300"><?php echo e($pegawai->id); ?></td>
                    ...
                    <td class="py-2 px-4 border border-gray-300"><?php echo e($pegawai->unitkerja->nama ?? '-'); ?></td>
...
<?php /**PATH C:\xampp\htdocs\pemweb2\room-booking\room-booking\resources\views/livewire/pegawai/list-pegawai.blade.php ENDPATH**/ ?>